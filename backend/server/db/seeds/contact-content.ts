...
const blocks: Block[] = [
  ...
  { pagePath: PAGE, blockKey: "contact.info.hours.label", content: bi("Elérhetőség", "Availability"), contentType: "json" },
  { pagePath: PAGE, blockKey: "contact.info.hours.weekdays", content: bi("9–19, hétfő–szombat", "9 AM – 7 PM, Monday–Saturday"), contentType: "json" },
