    ...
    >
      <div className="container mx-auto px-4">
          ...
          <div className="relative mr-auto shrink-0 flex items-center self-stretch overflow-hidden" ref={logoEditorRef}>
            ...
            >
              <img
                ...
                className={`h-[6.75rem] md:h-[10.5rem] lg:h-[10.75rem] max-h-full w-auto rounded object-contain ${isAdmin ? "ring-2 ring-dashed ring-blue-400/50" : ""}`}
                style={
        ...
        {menuOpen && (
          <div
            id="mobile-menu"
            className="lg:hidden pb-4 border-t border-[#0B2340]/15 max-h-[calc(100vh-7rem)] overflow-y-auto"
          >
